...
use App\Http\Controllers\Generalinfo;
...
Route::group(['middleware' => 'auth'], function(){
	...
	Route::get('/admin/generalinfo/{lang}', [Generalinfo::class,'index']);
	Route::post('/admin/savelogos', [Generalinfo::class,'savelogos'])->name('savelogos');
	Route::post('/admin/savegenral/', [Generalinfo::class,'savegenral'])->name('savegenral');

	


	Route::get('/admin/sliderinfo', [Generalinfo::class,'sliderinfo']);
	Route::get('/admin/addslider', [Generalinfo::class,'addslider'])->name('add-slider');
	Route::post('/admin/addnewsliderdata', [Generalinfo::class,'addnewsliderdata'])->name('addnewsliderdata');
	Route::any('/admin/editnewsliderdata/{id}', [Generalinfo::class,'editnewsliderdata'])->name('editnewsliderdata');
	Route::post('/admin/deleteslider/', [Generalinfo::class,'removeslider'])->name('removeslider');



	

	Route::get('/admin/aboutus/{lang}', [Generalinfo::class,'aboutus']);
	Route::any('/admin/editaboutus/{id}', [Generalinfo::class,'editaboutus'])->name('editaboutus');


	Route::get('/admin/services', [Generalinfo::class,'services']);
	Route::get('/admin/addservices', [Generalinfo::class,'addservices'])->name('add-services');
	Route::post('/admin/addservicesdata', [Generalinfo::class,'addservicesdata'])->name('addservicesdata');
	Route::any('/admin/editservicesdata/{id}', [Generalinfo::class,'editservicesdata'])->name('editservicesdata');
	Route::post('/admin/deleteservices/', [Generalinfo::class,'removeservice'])->name('removeservices');



		Route::get('/admin/newsandblog', [NewsController::class,'index']);
	Route::get('/admin/addnews', [NewsController::class,'addnews'])->name('add-news');
	Route::post('/admin/addnewsdata', [NewsController::class,'addnewsdata'])->name('addnewsdata');
	Route::any('/admin/editnewsdata/{id}', [NewsController::class,'editnewsdata'])->name('editnewsdata');
	Route::post('/admin/deletenews/', [NewsController::class,'removenews'])->name('removenews');
	...
	Route::get('/admin/contactus', [ContactusController::class,'index']);
		Route::any('/admin/editcontactsdata/{id}', [ContactusController::class,'editcontactsdata'])->name('editcontactsdata');
	Route::post('/admin/deletecontacts/', [ContactusController::class,'removecontacts'])->name('removecontacts');
	Route::post('/admin/updatestatus/', [ContactusController::class,'updatestatus'])->name('updatestatus');
